...
D84x = [5.320 2.656 6.253 4.707 3.666 4.068 2.754 3.473 4.369 5.349];
...
D84y1 = [2.524 2.473 3.164 3.084 3.375 1.865 1.670 2.853];
...
D84y2 = [1.472 2.568 3.960 2.396 6.000 3.312 3.901];
...
D84y3 = [0.487 2.132 3.566 3.095 4.758 2.224 1.439];
...
D84y0 = [1.060 0.437 0.415];

labelsY0 = {'lagoon', 'TF7', 'TF8'};

%% Visualisation: cross-shore transect
figure2('Name', 'Cross-shore transects')
bar([D50x;D84x]', 'grouped')
legend('D$_{50}$', 'D$_{84}$')
