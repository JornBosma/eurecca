function PHZD_z = JDN_xyz(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   PHZDQ4GRIDOPGESCHOOND = IMPORTFILE1(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   PHZDQ4GRIDOPGESCHOOND = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PHZD_z = JDN_elevation('081909_PHZD_Q4_Grid_Opgeschoond.xyz', 1, inf);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/05/26 11:57:26
...
PHZD_z = table(dataArray{1:end-1}, 'VariableNames', {'xRD','yRD','z'});
