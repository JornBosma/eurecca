...
%% Visualisation of all horizontal sample locations (latex)
f0 = figure;
...
title({'2021-09-20 \quad 2021-10-07','2021-09-28 \quad 2021-10-15','2021-10-01\qquad\qquad\qquad'}, 'FontSize',fontsize*.7, 'Units','normalized',...
    'Position',[.5, .65]);
...
title({'2021-09-30 \quad 2021-10-11','2021-10-01 \quad 2021-10-13','2021-10-06\qquad\qquad\qquad'}, 'FontSize',fontsize*.7, 'Units','normalized',...
    'Position',[.5, .65]);
...
xlim([ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9, ax10, ax11, ax12], xl);
ylim([ax1, ax2, ax3, ax4, ax5, ax6, ax7, ax8, ax9, ax10, ax11, ax12], yl);
...
%% Visualisation of all horizontal sample locations (tex)
f0 = figure;
tiledlayout(3,4, 'TileSpacing','none', 'Padding','tight')
...
yline(MHWS, '--', 'MHWS', 'FontSize',fontsize*.7, 'LineWidth',2)
yline(MSL, '-.', 'MSL', 'FontSize',fontsize*.7, 'LineWidth',2)
yline(MLWS, '--', 'MLWS', 'FontSize',fontsize*.7, 'LineWidth',2)
