...
for k = 1:numel(fn)
    if( isnumeric(pgons.(fn{k})) )
        patch(pgons.(fn{k})(:,1), pgons.(fn{k})(:,2), clrs(k,:), 'FaceAlpha',.1, 'EdgeColor',clrs(k,:), 'LineWidth',3)
    end
end
...
patch(pgons.(fieldName1)(:,1), pgons.(fieldName1)(:,2), 'y', 'FaceAlpha',.1, 'EdgeColor','y', 'LineWidth',3)
patch(pgons.(fieldName2)(:,1), pgons.(fieldName2)(:,2), 'r', 'FaceAlpha',.1, 'EdgeColor','r', 'LineWidth',3)
patch(pgons.(fieldName3)(:,1), pgons.(fieldName3)(:,2), 'b', 'FaceAlpha',.1, 'EdgeColor','b', 'LineWidth',3)
...
patch(pgons.(fieldName1)(:,1), pgons.(fieldName1)(:,2), 'b', 'FaceAlpha',.1, 'EdgeColor','b', 'LineWidth',3)
patch(pgons.(fieldName2)(:,1), pgons.(fieldName2)(:,2), 'y', 'FaceAlpha',.1, 'EdgeColor','y', 'LineWidth',3)
patch(pgons.(fieldName3)(:,1), pgons.(fieldName3)(:,2), 'r', 'FaceAlpha',.1, 'EdgeColor','r', 'LineWidth',3)
patch(pgons.(fieldName4)(:,1), pgons.(fieldName4)(:,2), 'c', 'FaceAlpha',.1, 'EdgeColor','c', 'LineWidth',3)
patch(pgons.(fieldName5)(:,1), pgons.(fieldName5)(:,2), 'm', 'FaceAlpha',.1, 'EdgeColor','m', 'LineWidth',3)
patch(pgons.(fieldName6)(:,1), pgons.(fieldName6)(:,2), 'k', 'FaceAlpha',.1, 'EdgeColor','k', 'LineWidth',3)
% patch(pgons.(fieldName7)(:,1), pgons.(fieldName7)(:,2), 'k', 'FaceAlpha',.1, 'EdgeColor','k', 'LineWidth',3)

ax = gca; ax.SortMethod = 'childorder';

lgnd = ['2019 Q0'; '2022 Q4'; fieldName1; fieldName2; fieldName3; fieldName4; fieldName5; fieldName6];
legend(lgnd)
