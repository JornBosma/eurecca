...
f1 = figure('Position',[1910, 946, 1279, 391]);
...
f2 = figure('Position',[1910, 475, 1279, 391]);
tiledlayout(6, 6, 'TileSpacing','tight', 'Padding','compact')
...
f3 = figure('Position',[1910, 4, 1279, 391]);
tiledlayout(6, 6, 'TileSpacing','tight', 'Padding','compact')
...
f4 = figure('Position',[630, 4, 1279, 391]);
tiledlayout(6, 6, 'TileSpacing','tight', 'Padding','compact')
...
contourf(A.DEM.X, A.DEM.Y, A.DEM.Z, [0 1])
colormap([0.9804, 0.9216, 0.8431; 1 1 1]);
% contour(B.DEM.X, B.DEM.Y, B.DEM.Z, [-1.4 -1.4], 'k')

% Instrument locations
scatter(OSSI(:,1), OSSI(:,2), 150, 'filled', 'MarkerEdgeColor','k')
text(OSSI(:,1)+40, OSSI(:,2)+20, OSSI_names, 'FontSize',fontsize*.6)
